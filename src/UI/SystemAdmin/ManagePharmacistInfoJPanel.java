 ...
 * @author devikaboddu
 */
public class ManagePharmacistInfoJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManagePharmacistInfoJPanel
     */
   private final JPanel userProcessContainer;
    private final EcoModel ecoSystem;
    User userAccount;
    
    public ManagePharmacistInfoJPanel(JPanel userProcessContainer, EcoModel system) {
        initComponents();
...
//        for (User user : ecoSystem.getUserAccountDirectory().getUserList()) {
//
//            if ("Business.Role.PatientRole".equals(user.getUserRole().getClass().getName())) {
...
//        }
    ...
    private void initComponents() {
        ...
        lblManageCustomers.setText("                      Manage Pharmacists");
        add(lblManageCustomers, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 700, 70));
