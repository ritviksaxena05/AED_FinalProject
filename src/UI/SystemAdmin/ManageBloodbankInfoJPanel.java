 ...
 * @author devikaboddu
 */
public class ManageBloodbankInfoJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageBloodbankInfoJPanel
     */
    private final JPanel userProcessContainer;
    private final EcoModel ecoSystem;
    User userAccount;
    
    public ManageBloodbankInfoJPanel(JPanel userProcessContainer, EcoModel system) {
        initComponents();
